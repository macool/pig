...
ActiveRecord::Schema.define(version: 20150608151718) do
  ...
  add_index "pig_content_attributes", ["content_type_id"], name: "index_pig_content_attributes_on_content_type_id"
  ...
  add_index "pig_content_chunks", ["content_package_id", "content_attribute_id"], name: "index_content_on_package_attribute", unique: true
  ...
  add_index "pig_content_packages_personas", ["content_package_id"], name: "index_pig_content_packages_personas_on_content_package_id"
  ...
  add_index "pig_navigation_items", ["parent_id"], name: "index_pig_navigation_items_on_parent_id"
  ...
  add_index "pig_permalinks", ["full_path"], name: "index_pig_permalinks_on_full_path"
  add_index "pig_permalinks", ["path"], name: "index_pig_permalinks_on_path"
  ...
  add_index "pig_personas", ["group_id"], name: "index_pig_personas_on_group_id"
  ...
  add_index "pig_resource_tag_categories", ["tag_category_id"], name: "index_pig_resource_tag_categories_on_tag_category_id"
  add_index "pig_resource_tag_categories", ["taggable_resource_id", "taggable_resource_type"], name: "index_resource_id_and_type"
  add_index "pig_resource_tag_categories", ["taggable_resource_id"], name: "index_pig_resource_tag_categories_on_taggable_resource_id"
  ...
  add_index "pig_users", ["email"], name: "index_pig_users_on_email", unique: true
  add_index "pig_users", ["reset_password_token"], name: "index_pig_users_on_reset_password_token", unique: true
